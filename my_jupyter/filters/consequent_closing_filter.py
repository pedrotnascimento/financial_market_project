...
from my_jupyter.indicator.consequent_closing_counter import ConsequentClosingCounterIndicator
...
class ConsequentClosingFilter(FilterBase):
    def __init__(self, candles=5):
        super().__init__(candles)
        self.period = candles
        self.candle_counter = ConsequentClosingCounterIndicator(candles)

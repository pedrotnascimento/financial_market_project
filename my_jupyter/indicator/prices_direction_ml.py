from my_jupyter.modules.prices_direction_ml_backtest import PriceDirectionMLBacktest
...
class PricesDirectionML:
    ...
    def create_model(self, len_):
        model = tf.keras.Sequential(
            [
                tf.keras.layers.Input(shape=(len_,)),
